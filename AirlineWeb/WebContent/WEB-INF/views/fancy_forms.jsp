...
<title>OMG These forms be so fancy! And Airline Related...</title>
</head>
<body>
	<!DOCTYPE html>
...
<body>
	...
	<form method="POST" action="AddFlight">
		...
		<select name="from_destination">
			...
			<option value="The_Shire">The Shire</option>
		</select>
	...
	<h1>Add flight to passenger <span
			style="font-size: 16px; vertical-align: middle;">(give a passenger another flight ticket to his\her collection of flight tickets)</span>
	</h1>
